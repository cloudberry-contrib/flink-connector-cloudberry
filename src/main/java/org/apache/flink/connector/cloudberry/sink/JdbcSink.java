...
package org.apache.flink.connector.cloudberry.sink;
...
import org.apache.flink.connector.cloudberry.sink.writer.JdbcOutputFormat;
...
public class JdbcSink {
  ...
  public static <T> SinkFunction<T> sink(
    ...
    return sink(sql, statementBuilder, JdbcWriteOptions.defaults(), connectionOptions);
  }
   ...
   * @param statementBuilder sets parameters on {@link java.sql.PreparedStatement} according to the
   *     query
  ...
  public static <T> SinkFunction<T> sink(
      ...
      JdbcConnectionOptions connectionOptions) {
    return new GenericJdbcSinkFunction<T>(
        new JdbcOutputFormat<>(
            new SimpleJdbcConnectionProvider(connectionOptions),
            writeOptions,
            context -> JdbcBatchStatementExecutor.simple(sql, statementBuilder),
